...
class LSESolver:
    ...
    def solve_linear_system_quantum(self):
        ...
        combined_circuit.initialize(b_normalized, 0)
        ...
        print("Statevector after QSVT:", Statevector.from_instruction(combined_circuit))
        ...
        x_solution = self.measure_real_amplitudes(qsvt_circuit, b_normalized)
        print("x_solution before scaling:", x_solution)
    ...
    def _reconstruct_from_counts(self, counts):
        ...
        """
        # anc=0のカウントだけ抜く
        post_counts = {bits: c for bits, c in counts.items() if bits[0] == "0"}
        print("post_counts:", post_counts)
